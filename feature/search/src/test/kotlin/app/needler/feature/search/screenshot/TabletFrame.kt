 ...
 * is a labelled placeholder of the pack's `sidebarWidth`. What that leaves
 * between them is the content pane the app will actually give this screen:
 * 1280 − 96 − 400 = 784dp.
 */
@Composable
        ...
        Column(
            ...
            Text(
                text = "Artwork, transport, output and the crate are built in :feature:player " +
                    ...
                    "content pane beside it is the width Search really gets.",
